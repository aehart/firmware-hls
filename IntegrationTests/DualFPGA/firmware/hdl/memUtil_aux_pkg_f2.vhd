...
package memUtil_aux_pkg_f2 is
  ...
  type t_f2_in is record
    ...
    TW_113_stream_A_full_neg  :  t_arr_TW_113_1b;
    DW_49_stream_A_full_neg   :  t_arr_DW_49_1b;
    BW_46_stream_A_full_neg   :  t_arr_BW_46_1b;
  end record t_f2_in;
  ...
  constant c_f2_in_init : t_f2_in := (
    ...
    TW_113_stream_A_full_neg  =>  (others => '0'),
    DW_49_stream_A_full_neg   =>  (others => '0'),
    BW_46_stream_A_full_neg   =>  (others => '0')
  );
