...
architecture behaviour of tb_tf_top is
  ...
  constant CLK_PERIOD_240           : time    := 4.166 ns;       --! 240 MHz
  constant CLK_PERIOD_360           : time    := 2.777 ns;       --! 360 MHz
...
--! @brief Make clock ---------------------------------------
  clk240 <= not clk240 after CLK_PERIOD_240/2;
  clk360 <= not clk360 after CLK_PERIOD_360/2;
